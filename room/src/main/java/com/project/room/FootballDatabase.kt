...
@Database(entities = [Match::class,CompetitionsUiState::class, Table::class, RoomTeam::class, MatchesByDate::class], version = 1)
@TypeConverters(MatchTypeConverter::class, AwayTeamTypeConverter::class,
    ...
    RoomTeamTypeConverter::class, MatchesByDateTypeConverter::class)
